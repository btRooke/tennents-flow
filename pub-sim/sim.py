...
def sim_cmd():
    ...
    arg_parser.add_argument("-v", "--venue_path", type = str, default = "example/StA_spoons_venue_data.json", help="Path to venues file")
    arg_parser.add_argument("-d", "--distribution_path", type = str, default="example/StA_spoons_venue_distribution.json", help="Path to start venue probability distribution")
